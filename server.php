...
$db = mysqli_connect('localhost', 'root', '', 'registation');
...
//if there is no error and save user to database
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO user (firstname,lastname,student_id, email,phone_no,batch, password)
  			  VALUES('$firstname','$lastname','$student_id', '$email', '$phone_no','$batch','$password')";
